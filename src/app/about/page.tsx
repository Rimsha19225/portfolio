...
const About = () => {
  return (
    <div>
      <div className="about w-full h-screen flex justify-center shadow-black shadow-2xl items-center gap-24 align-center bg-fixed">
        <div className="box">
